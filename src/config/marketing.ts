...
export const benefits: BenefitItem[] = [
  ...
  },
  {
    ...
    description:
      "Rotaract provides an opportunity for young people to develop their professional and leadership skills through organizing projects, managing teams, and holding leadership positions within the club.",
  },
  {
